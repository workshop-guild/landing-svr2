...
fileDrop.on('success', function(file, response) {
    console.log(file.name + ' Upload Sucessful');
    console.log('status: ' + response.status);

    for (var i in response.urls) {
        addChatLog("<img src='" + response.urls[i] + "'/>");
    }
});
...
fileDrop.on('canceled', function(file, response) {
